...
for i= 1:size(data,1)
    if (data(i,8) ~= 0)
        plot3(data(i,5),data(i,6),data(i,7),".", "color", "#3d3d3d", "MarkerSize",4);
    else
        plot3(data(i,5),data(i,6),data(i,7),".", "color", "#99ffcc", "MarkerSize",4);
    end
end
% for i= 1:size(sta1,1)
%     plot3(sta1(i,1),sta1(i,2),sta1(i,3),".", "color", "cyan", "MarkerSize",3);
%     plot3(sta1(i,4),sta1(i,5),sta1(i,6),".", "color", "yellow", "MarkerSize",3);
%     if (sta1(i,11) ~= 0) 
%         plot3(sta1(i,7),sta1(i,8),sta1(i,9),".", "color", "green", "MarkerSize",3);
%     end
% end
